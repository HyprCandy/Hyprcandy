...
[HyprCandy+](https://mirukai.gumroad.com/l/mmnrfq) is a stylish and functional Hyprland configuration cohesively themed entirely through [matugen](https://github.com/InioX/matugen.git) and [pywal](https://github.com/eylles/pywal16.git) with an incredible amount of extra quality of life features over the familiar free HyprCandy setup. If I find free alternatives for my supporting processes then ****PLUS**** will also become ****FREE**** in future.
---
