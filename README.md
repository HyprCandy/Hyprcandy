...
➡[UltraCandy](https://ko-fi.com/s/f56114285c)/free [HyprCandy](https://github.com/HyprCandy/hyprcandyinstall.git)⬅ is a system-wide, cohesively themed Hyprland configuration for Arch and Arch-based distributions with extra quality of life features. I recommend waybar if you desire a taskbar-like experience when you toggle it on/off since hyprpanel takes longer to relaunch. 
