...
If you like my work, get a copy of the [install scipt](https://mirukai.gumroad.com/l/cxsyj) ($5 for my sleepless all-nighters 🙂) or grab bits and bops from the [main repo](https://github.com/HyprCandy/Hyprcandy.git) or you can [support the project](https://ko-fi.com/ianmking) 🙂.
