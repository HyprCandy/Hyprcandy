...
If you like my work, get a copy of the free [install scipt](https://github.com/HyprCandy/hyprcandyinstall.git) or grab bits and bops from the [main repo](https://github.com/HyprCandy/Hyprcandy.git) or you can [support my work](https://ko-fi.com/ianmking) 🙂.
